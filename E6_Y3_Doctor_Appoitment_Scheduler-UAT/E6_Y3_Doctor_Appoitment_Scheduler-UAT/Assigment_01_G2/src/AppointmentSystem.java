...
public class AppointmentSystem {
    ...
    public static void main(String[] args) {
        ...
        if (option == 1) {
            ...
            Doctor doctor13 = new Doctor("Dr. Sokea ", "Oncologist", true );
            Doctor doctor14 = new Doctor("Dr. Lomg ", "Dentist", true);
            Doctor doctor15 = new Doctor("Dr. Tongvorng","Dentist",false);
            ...
            doctors.put(doctor13.name,doctor13);
            doctors.put(doctor14.name,doctor14);
            doctors.put(doctor15.name,doctor15);
